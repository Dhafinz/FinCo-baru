...
<body>
        ...
        <div class="container nav-wrap" id="navWrap">
            ...
            <div class="nav-auth">
                <?php if(auth()->guard()->check()): ?>
                    <a class="btn btn-outline" href="<?php echo e(url('/dashboard')); ?>">Dashboard</a>
                <?php else: ?>
                    <?php if(Route::has('login')): ?>
                        <a class="btn btn-outline" href="<?php echo e(route('login')); ?>">Masuk</a>
                    <?php endif; ?>
    ...
    <main>
        ...
        <div class="container">
            <section class="cta" aria-label="Call to action">
                ...
                <div class="hero-actions">
                    <?php if(Route::has('register')): ?>
                        <a class="btn btn-primary" href="<?php echo e(route('register')); ?>">Buat Akun Sekarang</a>
                    <?php endif; ?>
                    <?php if(Route::has('login')): ?>
                        <a class="btn btn-outline" href="<?php echo e(route('login')); ?>">Sudah Punya Akun</a>
                    <?php endif; ?>
                </div>
            </section>
        </div>
    ...
    <footer>
        <div class="container footer-wrap">
            <p>&copy; <?php echo e(now()->year); ?> FinCo. Financial Gamification Web App.</p>
...
<?php /**PATH C:\finco\resources\views/welcome.blade.php ENDPATH**/ ?>