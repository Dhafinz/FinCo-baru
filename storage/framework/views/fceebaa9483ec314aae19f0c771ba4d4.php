...
<body>
    <main class="card">
        ...
        <?php if(session('status')): ?>
            <div class="error-box" style="background:#eff6ff;color:#1e40af;border-color:#bfdbfe;"><?php echo e(session('status')); ?></div>
        <?php endif; ?>
        ...
        <p class="switch">Belum punya akun? <a href="<?php echo e(route('register')); ?>">Daftar</a></p>
    </main>
...
<?php /**PATH C:\finco\resources\views/auth/login.blade.php ENDPATH**/ ?>