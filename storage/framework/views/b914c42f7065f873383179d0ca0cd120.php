...
<head>
    ...
    <title><?php echo e($title ?? 'Dashboard'); ?> | FinCo</title>
...
<div class="app-shell">
    <aside class="card sidebar">
        ...
        <ul class="menu">
            <li><a class="<?php echo e(($menuActive ?? '') === 'overview' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard')); ?>">Overview <small>aktif</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'transactions' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.transactions')); ?>">Transaksi <small>fitur</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'budgets' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.budgets')); ?>">Budget <small>fitur</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'goals' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.goals')); ?>">Goals <small>fitur</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'quests' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.quests')); ?>">Quest <small>fitur</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'badges' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.badges')); ?>">Badges <small>fitur</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'leaderboard' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.leaderboard')); ?>">Leaderboard <small>fitur</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'wallet' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.wallet')); ?>">Wallet <small>baru</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'friends' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.friends')); ?>">Teman <small>baru</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'reports' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.reports')); ?>">Laporan <small>fitur</small></a></li>
            <li><a class="<?php echo e(($menuActive ?? '') === 'settings' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.settings')); ?>">Pengaturan <small>fitur</small></a></li>
            <?php if($user->isAdmin()): ?>
                 <li><a class="<?php echo e(($menuActive ?? '') === 'admin' ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>">Dashboard Admin <small>admin</small></a></li>
            <?php endif; ?>
        </ul>
    </aside>
    ...
    <div class="content-area">
        <header class="topbar">
            <div class="topbar-inner">
                <div>
                    <div class="location">Lokasi: Dashboard / <?php echo e($title ?? 'Halaman'); ?></div>
...
<?php /**PATH C:\finco\resources\views/layouts/dashboard-panel.blade.php ENDPATH**/ ?>