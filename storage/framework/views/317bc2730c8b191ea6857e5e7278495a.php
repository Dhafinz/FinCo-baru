...
<body>
    <div class="container">
        ...
        <?php if(session('success')): ?>
            <div class="card" style="padding:0.7rem 0.85rem;margin-bottom:0.75rem;border-color:#86efac;color:#166534;background:#f0fdf4;"><?php echo e(session('success')); ?></div>
        <?php endif; ?>
        <?php if($errors->any()): ?>
            <div class="card" style="padding:0.7rem 0.85rem;margin-bottom:0.75rem;border-color:#fecaca;color:#991b1b;background:#fff1f2;"><?php echo e($errors->first()); ?></div>
        <?php endif; ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <div class="item">
                        ...
                        <div style="text-align:right;">
                            ...
                            <div class="<?php echo e($isIncoming ? 'amount-plus' : 'amount-minus'); ?>" style="margin-top:0.25rem;">
...
<?php /**PATH C:\finco\resources\views/wallet/index.blade.php ENDPATH**/ ?>