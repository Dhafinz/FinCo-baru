    ...
    <div class="app-shell">
        <aside class="card sidebar">
            ...
            <ul class="menu">
                ...
                <?php if($user->isAdmin()): ?>
                    <li><a class="<?php echo e(($activeFeature ?? '') === 'admin' ? 'active' : ''); ?>" href="<?php echo e(route('admin.dashboard')); ?>">Dashboard Admin <small>admin</small></a></li>
                <?php endif; ?>
            </ul>
        </aside>
                        ...
                        <?php elseif($activeFeature === 'transactions'): ?>
                            ...
                            <section class="mode-banner card">
                                ...
                                <div class="mode-bar">
                                    ...
                                    <a class="<?php echo e($transactionMode === 'quest' ? 'active' : ''); ?>" href="<?php echo e(route('dashboard.quests', ['mode' => 'select'])); ?>">🎯 Quest</a>
                                </div>
                            </section>
                                        ...
                                        <form action="<?php echo e(route('dashboard.transactions.store')); ?>" method="POST" style="margin-top:0.75rem;" id="questForm">
                                            ...
                                            <div class="form-grid">
                                                ...
                                                <div class="field">
                                                    ...
                                                    <input id="quest_date" type="date" name="transaction_date" value="<?php echo e(old('transaction_date', now()->toDateString())); ?>" required <?php echo e($selectedQuestTemplate ? '' : 'disabled'); ?>>
                                                </div>
                                                <div class="field field-2">
                                                    <label for="quest_desc">Deskripsi</label>
                                                    <input id="quest_desc" type="text" name="description" maxlength="255" value="<?php echo e(old('description')); ?>" placeholder="Contoh: Nabung bulan ini" <?php echo e($selectedQuestTemplate ? '' : 'disabled'); ?>>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row-actions">
                                                ...
                                                <a href="<?php echo e(route('dashboard.quests', ['mode' => 'select'])); ?>" class="btn btn-soft" style="text-decoration:none;display:inline-flex;align-items:center;">Pilih Quest</a>
                                            </div>
                                        </form>
                                    <?php else: ?>
                                ...
                                <?php if(($questMode ?? null) === 'select'): ?>
                                    <article class="card panel" style="grid-column: 1 / -1;">
                                        ...
                                        <div style="margin-top:0.6rem;display:flex;gap:0.5rem;flex-wrap:wrap;">
                                            <a href="<?php echo e(route('dashboard.quests', ['flow' => 'income'])); ?>" class="btn btn-primary">Income (Nabung)</a>
                                            <a href="<?php echo e(route('dashboard.quests', ['flow' => 'expense'])); ?>" class="btn btn-soft">Expense (Hemat)</a>
                                            <a href="<?php echo e(route('dashboard.quests')); ?>" class="btn btn-soft">Tampilkan Semua</a>
                                        </div>
                                    </article>
                                <?php endif; ?>
