        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="grid">
                <div class="field">
                    ...
                    <input id="full_name" type="text" name="full_name" value="{{ old('full_name') }}" required autocomplete="name" placeholder="Nama lengkap kamu">
                </div>

                <div class="field">
                    <label for="username">Username</label>
                    <input id="username" type="text" name="username" value="{{ old('username') }}" required placeholder="contoh: finco_user">
                </div>
