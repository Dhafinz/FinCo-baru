...
<head>
    <meta charset="UTF-8">
    <title>Add Transaction - FinCo Admin</title>
        ...
        <div class="bg-white p-6 rounded shadow">
            <form action="/admin/transactions" method="POST">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="amount" class="w-full border rounded p-2" placeholder="100000">
                </div>
                <div class="mb-4">
                    <label class="block text-gray-700 mb-1">Description</label>
                    <input type="text" name="description" class="w-full border rounded p-2" placeholder="Deskripsi transaksi">
                </div>
                <div class="mb-4">
